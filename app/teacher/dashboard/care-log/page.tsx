...
import CareLogPageClient from './CareLogPageClient'
import { getCareLogStudentsForDate } from '@/app/actions/careLog'
...
export default async function CareLogPage() {
  ...
  const initialStudents = await getCareLogStudentsForDate(initialDate)
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex overflow-hidden">
        <CareLogPageClient initialStudents={initialStudents} initialDate={initialDate} />
      </main>
    </div>
  )
}
