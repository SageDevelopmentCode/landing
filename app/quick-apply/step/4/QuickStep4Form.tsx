...
import { saveQuickApplyStep4 } from "@/app/actions/saveQuickApplyStep4";
...
export default function QuickStep4Form({
  initialData,
  applicationId,
}: {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const result = await saveQuickApplyStep4({
        g1SignatureName,
        g1Signature,
        g1SignatureDate,
        applicationId,
      ...
      >
        ...
        >
          <Link
            href={
              applicationId
                ? `/quick-apply/step/3?appId=${applicationId}`
                : "/quick-apply/step/3"
            }
