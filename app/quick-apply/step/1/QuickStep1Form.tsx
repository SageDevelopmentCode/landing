...
import { saveQuickApplyStep1 } from "@/app/actions/saveQuickApplyStep1";
...
export default function QuickStep1Form({
  initialData,
  applicationId,
}: {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const result = await saveQuickApplyStep1({
        program,
        childLegalName,
        dobMonth,
        dobDay,
