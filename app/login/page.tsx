        ...
        {authMode === "password" ? (
          <form action={handleEmailPasswordSubmit} className="mt-8 space-y-6">
            ...
            <motion.button
              ...
              className="w-full flex justify-center items-center gap-2 py-4 px-4 text-base font-medium text-white focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-all duration-200"
              style={{
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <motion.button
              ...
              whileHover={{ scale: loading ? 1 : 1.02 }}
              whileTap={{ scale: loading ? 1 : 0.98 }}
              className="w-full flex items-center justify-center gap-3 py-4 px-4 bg-white text-base font-medium focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-all duration-200"
              style={{
                border: "1px solid #E8E4DF",
                borderRadius: "16px",
                color: "#3D3D3D",
