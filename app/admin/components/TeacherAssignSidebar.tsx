...
export function TeacherAssignSidebar({
  student,
  onClose,
  onAssigned,
        ...
        <SidebarSection title="Teacher Assignments">
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    ...
                    {CLASSROOM_LABELS[a.classroom ?? ""] ?? a.classroom ?? "—"}
                  </div>
                </div>
          ...
          {showAssignForm && (
            ...
            >
              ...
              {teachersLoading ? (
                ...
                >
                  {[0, 1, 2, 3].map((i) => (
                    ...
                    >
                      <div
                        className="bg-gray-100 rounded-full animate-pulse"
              ...
              {assignError && (
                <p style={{ color: colors.error, fontSize: 12, margin: 0 }}>
                  {assignError}
                </p>
              )}
