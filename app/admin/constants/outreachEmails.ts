...
export const OUTREACH_EMAIL_CATALOG: OutreachEmailCatalogEntry[] = [
  ...
  {
    id: "school-year-week-three-newsletter",
    label: "Send School Year Week Three Newsletter",
    category: "schoolYear",
  },
  {
    id: "school-year-week-four-newsletter",
    label: "Send School Year Week Four Newsletter",
    category: "schoolYear",
  },
  {
