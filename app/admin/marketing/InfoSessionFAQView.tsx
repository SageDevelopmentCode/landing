...
const faqSections: FAQSection[] = [
  {
    ...
    items: [
      {
        question:
          "How much does the Homeschool Drop-In cost for 1 day per week?",
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          'What does "ability-based grouping" actually mean in practice?',
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          "What's the process before a child is disenrolled for behavior?",
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          "What does Montessori vs. Waldorf vs. Reggio Emilia actually look like in the classroom?",
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          "What does the application and enrollment process look like step by step?",
        answer:
      ...
      {
        question:
          "What is the School Year 2026–2027 commitment, and what happens after March 2027?",
        answer:
      ...
      {
        question:
          "Can a homeschool drop-in child join a class mid-week alongside full-enrolled students?",
        answer:
  ...
  return (
    <div>
      <div style={{ marginBottom: "28px" }}>
        ...
        >
          Reference answers for common parent questions. Based on live website
          content.
        </p>
      </div>
