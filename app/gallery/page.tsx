...
const SCHOOL_YEAR_WEEK_THREE: GalleryImage[] = [
  "02629D21-AF3A-491F-A480-800E2BC9D13A.JPG",
  "0998A815-2BF1-4DC6-A090-9B435BAA86A0.JPG",
  "3E2ADEA5-14E8-4425-BB70-DA7B961D6B81.JPG",
  "43D4D8D3-74AA-44FF-9ACE-AAE5200B488D.JPG",
  "53022F5B-6203-4FDD-8D6D-4B75828F4FEC.JPG",
  "58F5BDB7-F1F1-4845-B1C9-0164C3A3706C.JPG",
  "5DADF1CF-46A4-4F2E-95E6-FD0C5178DDDB.JPG",
  "6835EA49-0B94-4938-958E-EF8A928C37BC.JPG",
  "81287082-FDCF-46E1-85F5-C8E180CE2048.JPG",
  "82F510EF-6FD1-4DDD-9408-D9D4F92ECF2E.JPG",
  "929BF89E-E892-4CBA-BED0-15E615073B7C.JPG",
  "A51200E9-A655-4DC4-86FC-7C61FD3DF569.JPG",
  "BC3C9DF3-4ECB-4F82-B635-FA1455F6A791.JPG",
  "CB1792E7-4ABF-4FEE-96C6-C5724F7F9F4B.JPG",
  "CEF8BE2C-4D30-46C1-B160-A35398EECBA5.JPG",
  "DE833B8B-C649-456F-B74D-DA35E0F98F35.JPG",
  "EF974DD3-7C8C-4F7F-8CB6-E2F7606D2492.JPG",
  "FBD9727C-AB5D-4217-8CFE-E2F1D6119641.JPG",
].map((f) => ({
  src: `/assets/highlights/school_week_three/${f}`,
  alt: `School Year Week 3 — ${f}`,
  week: 3,
}));
...
const WEEK_ELEVEN: GalleryImage[] = [
  ...
  "19757EE4-381F-4ADD-B6D5-1735915562F8.JPG",
  "42756484-192D-4F31-B65A-397C0DD18AC6.JPG",
  "4C092707-8925-4F04-A27E-DB164364E8BF.JPG",
  "5A3AF327-F0A7-43BF-9B1B-D79EC07F2D98.JPG",
  "5C4777E0-34AF-463F-8B4D-F166DEFB5F5C.JPG",
  "5C59AB4B-B437-4900-8F87-AC9ACD900DED.JPG",
  "5D55FD03-B5FE-4D08-A1ED-AF3A71061450.JPG",
  "5D8FDA30-00DF-4E4B-82D1-9AEBBD2F8E4E.JPG",
  "611930E7-1ADF-49A7-A2C0-C081221BD854.JPG",
  "71F6051C-9FE1-4EE5-B36D-01F87A23398D.JPG",
  "7892E368-C227-4499-B5FD-0E6CEBAAE5FD.JPG",
  "7A9CC1BE-BE47-4DDD-B413-F8A012DADBDF.JPG",
  "7C7B4561-A878-42EB-8D52-281C607B9562.JPG",
  "86334E46-E95A-4381-9DA4-1E01CEA619E7.JPG",
  "86D37C4D-6D74-492D-9C29-FC9529679A7C.JPG",
  "9C77B765-A833-49D4-8719-7D1D6E979922.JPG",
  "9E086650-1583-4069-8953-C11529996D16.JPG",
  "A8F848C9-ADDA-49D4-BD5D-A9D274495A4B.JPG",
  "B2641E90-3CBA-4775-B307-B24C1D73CF47.JPG",
  "CF99A61C-FBCF-4EE2-B919-333DF0619A6F.JPG",
  "D5914D9F-067C-4D58-A69E-5E67E00D12B9.JPG",
  "F4D4E35B-C7CD-49BD-B022-1DD4AC79F982.JPG",
  "FAA98C1D-4882-447C-BF27-2EEA07C5453F.JPG",
  "IMG_0754.jpg",
  "IMG_0801.jpg",
  "IMG_0812.jpg",
].map((f) => ({ src: `/assets/highlights/summer_week_eleven/${f}`, alt: `Week 11 — ${f}`, week: 11 }));
...
const ALL_IMAGES: GalleryImage[] = [...SCHOOL_YEAR_WEEK_THREE, ...SCHOOL_YEAR_WEEK_TWO, ...WEEK_TWELVE, ...WEEK_ELEVEN, ...WEEK_SIX, ...WEEK_FIVE, ...WEEK_FOUR, ...WEEK_THREE, ...WEEK_TWO, ...WEEK_ONE];
