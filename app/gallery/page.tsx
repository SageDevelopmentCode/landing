...
const ALL_IMAGES: GalleryImage[] = [...SCHOOL_YEAR_WEEK_FOUR, ...SCHOOL_YEAR_WEEK_THREE, ...SCHOOL_YEAR_WEEK_TWO, ...WEEK_TWELVE, ...WEEK_ELEVEN, ...WEEK_SIX, ...WEEK_FIVE, ...WEEK_FOUR, ...WEEK_THREE, ...WEEK_TWO, ...WEEK_ONE];
