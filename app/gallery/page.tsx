...
const SCHOOL_YEAR_WEEK_FIVE: GalleryImage[] = [
  "03B0FFDA-ACC9-4F70-B82C-B16EBACD5636.JPG",
  "05A3BE7A-1DE2-4C9E-91EC-769F1888C0AD.JPG",
  "1BDB4106-7495-45A8-9391-3BED523FA5C1.JPG",
  "29AB0AD4-AEDD-4145-A6A9-5FA6D8FD605E.JPG",
  "4182F696-085D-47CB-9021-8F8F5DC1BD9D.JPG",
  "5246214C-00FC-4ED2-8369-7FD5DDCF29D3.JPG",
  "6F5B4460-BFF1-486C-9DAB-B7B1BB4C2FFD.JPG",
  "7A2E475F-76BD-4718-A484-854DA4FC48B5.JPG",
  "89C4E0CC-3A0E-479B-8DE9-2FA03D891A80.JPG",
  "96D93AFA-3B3B-4959-A75F-DD9624B41C29.JPG",
  "9965B812-C19C-45DF-97DF-031DDDF9381E.JPG",
  "BFF44DC7-3510-46E9-8D96-6DB9C96E90C5.JPG",
  "CCACC24E-0E7A-4442-99F4-F0596DCB4134.JPG",
  "DEFE850C-99B6-4015-B419-89FDE3617DA0.JPG",
  "F157BD53-B669-429C-8613-5634FA945599.JPG",
  "F232DFAA-059D-4705-80AC-EDB763175364.JPG",
  "F47AC380-A0C2-4C05-80B3-C3FC804976EF.JPG",
  "F855F2DE-4407-4A85-8F6A-52F5C8EAA910.JPG",
  "FC66AAAA-7A33-4614-B36B-B553F5EAEF6D.JPG",
].map((f) => ({
  src: `/assets/highlights/school_week_five/${f}`,
  alt: `School Year Week 5 — ${f}`,
  week: 5,
}));

const SCHOOL_YEAR_WEEK_FOUR: GalleryImage[] = [
  "01C20017-202A-4B7C-ADA0-34086EC915F2.JPG",
  "070B83EA-9BF5-4BAA-8818-544F74A17D7D.JPG",
  "0CB1B88B-28F6-40D0-932B-74464F657179.JPG",
  "0F828667-233A-47E9-938E-4F8408DB305B.JPG",
  "14F261B7-D0EE-4B9F-A7BD-4AD46DF24F97.JPG",
  "189F9697-2F44-41CB-BF88-F45CFBDCD90A.JPG",
  "1E3974E9-2C4E-4DF4-BF67-A340818CA09F.JPG",
  "264087A9-CBD5-4099-95FC-1B49CC9517E7.JPG",
  "43B558AD-2EDC-4E8F-B1ED-7CCFD765F730.JPG",
  "5E785DE4-8552-4D0B-A96D-85754832B6F0.JPG",
  "6F80F35B-3B69-4D26-8868-92A93A382AE1.JPG",
  "818F2757-ACE1-41D0-A62F-52F47C9C59E2.JPG",
  "84055570-13D0-4A73-95E2-84BFA0387408.JPG",
  "9A368F27-0C4F-4DD7-995B-98CC5DB2BE52.JPG",
  "9C5DFF55-97C6-4FEE-A82C-44A4BFB9BF5D.JPG",
  "9E8CD956-4831-42F7-AAA0-F2D94DBF1C1D.JPG",
  "A6DB1350-9D81-456C-87DE-8FF7C4727661.JPG",
  "B3A30FDD-AAB6-496E-802A-B30FA7CB4446.JPG",
  "B52828BB-4A7E-4F36-A133-1172281D5E59.JPG",
  "B75BE347-443C-4635-B998-6FE3C16B2E5E.JPG",
  "C1390CB2-0CD0-4B86-8360-32B658D5E5E2.JPG",
  "C7FBC6F6-803F-4663-AF3A-B18941AA7373.JPG",
  "E10B5084-3A5E-44CC-B113-2CD6FD96A460.JPG",
  "E80B575A-31D0-4051-9685-1E058790F1D2.JPG",
  "F90D4E80-7C91-4DEE-98F4-67F7FFB3F66B.JPG",
].map((f) => ({
  src: `/assets/highlights/school_week_four/${f}`,
  alt: `School Year Week 4 — ${f}`,
  week: 4,
}));
...
const ALL_IMAGES: GalleryImage[] = [...SCHOOL_YEAR_WEEK_FIVE, ...SCHOOL_YEAR_WEEK_FOUR, ...SCHOOL_YEAR_WEEK_THREE, ...SCHOOL_YEAR_WEEK_TWO, ...WEEK_TWELVE, ...WEEK_ELEVEN, ...WEEK_SIX, ...WEEK_FIVE, ...WEEK_FOUR, ...WEEK_THREE, ...WEEK_TWO, ...WEEK_ONE];
