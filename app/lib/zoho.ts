...
export async function buildParentTeacherConferenceRescheduleEmail(opts: {
  g1FullName: string;
  childLegalName: string;
  scheduleUrl?: string;
}): Promise<{ subject: string; content: string }> {
  ...
  const scheduleUrl =
    opts.scheduleUrl ?? "https://sagefield.co/parent/home";
  const subject =
    "Please reschedule your parent-teacher conference — Sage Field School";
  const content = `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8" /></head>
<body style="font-family: Georgia, serif; color: #2c2c2c; max-width: 600px; margin: 0 auto; padding: 32px 24px; line-height: 1.7;">
  ...
  <p>We sincerely apologize for the inconvenience. We have found it works best for families and for the flow of our school day to hold parent-teacher conferences <strong>after 3:00 PM</strong> — giving teachers uninterrupted time with students during the day and offering families a more relaxed window to connect. Unfortunately, we did not update the scheduling portal in time, and your conference for <strong>${opts.childLegalName}</strong> was booked at a time before 3:00 PM.</p>

  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; margin: 28px 0; border-radius: 4px;">
    <p style="margin: 0; font-size: 14px; color: #2c2c2c;">We have <strong>cancelled that appointment on our end</strong>. When you have a moment, please choose a new time at <strong>3:00 PM or later</strong> through the Parent Portal. Conferences are optional, but we would love the chance to connect with you — you may choose <strong>in-person or virtual</strong>.</p>
  </div>

  <div style="text-align: center; margin: 28px 0;">
    <a href="${scheduleUrl}" style="background: #2C5F2E; color: #ffffff; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-family: Georgia, serif; font-size: 15px; display: inline-block;">Reschedule Your Conference →</a>
  </div>

  <p style="margin-bottom: 8px; font-size: 14px; color: #555;">You can also schedule through the <strong>Sage Field mobile app</strong> from your home screen.</p>

  <p>If you have any questions, please reach out to us at <a href="mailto:sabrina@sagefield.co" style="color: #5a7a5a;">sabrina@sagefield.co</a> or call/text <a href="tel:5126775872" style="color: #5a7a5a;">(512) 677-5872</a>.</p>
...
export async function buildSummerWeekElevenNewsletterEmail(opts: {
  g1FullName: string;
  childLegalName: string;
}): Promise<{ subject: string; content: string }> {
  const firstName = opts.g1FullName.split(" ")[0];
  const subject =
    "Week Eleven Newsletter — August Tuition Due Tomorrow (Aug 10) 🌿";
  const content = `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8" /></head>
<body style="font-family: Georgia, serif; color: #2c2c2c; max-width: 600px; margin: 0 auto; padding: 32px 24px; line-height: 1.7;">
  ...
  <div style="background: #fffbeb; border: 1px solid #fcd34d; border-radius: 8px; padding: 20px 24px; margin-bottom: 24px; font-size: 14px; color: #2c2c2c;">
    <p style="margin: 0 0 8px 0; font-size: 15px; font-weight: bold; color: #b45309;">💳 Reminder: August Tuition Due Tomorrow</p>
    <p style="margin: 0 0 12px 0;">August tuition is due <strong>tomorrow, August 10</strong> — one week before school starts on Monday, August 17. If you haven't already, please complete payment in your Parent Portal.</p>
    <p style="margin: 0;"><a href="https://www.sagefield.co/parent/billing" style="color: #b45309; font-weight: bold;">View billing details →</a></p>
  </div>

  <p style="margin-bottom: 20px;">It was a week full of thoughtful writing, problem-solving, and meaningful opportunities to strengthen the skills our students use across all areas of learning.</p>

  <h2 style="font-size: 17px; color: #2C5F2E; margin-top: 32px; margin-bottom: 14px;">🌿 What We've Been Up To</h2>
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>✏️ <strong>Creative Writing (Lower &amp; Upper El)</strong> — sentence starters, persuasive writing, and informative writing to develop ideas and express themselves with greater detail and confidence</li>
      <li>📝 <strong>ELA: Revising, Editing &amp; Grammar</strong> — students practiced looking back at their own writing, making thoughtful improvements, and strengthening their sentences</li>
      <li>📊 <strong>Math: Data Analysis &amp; Graphing</strong> — collecting, organizing, representing, and interpreting data to make observations and draw conclusions</li>
      <li>🥔 <strong>Cooking: Loaded Baked Potato Fries</strong> — washing, prepping, assembling, and preparing food; students loved taking an active role in creating their own delicious meal</li>
    </ul>
  </div>

  <p style="margin-bottom: 20px; font-size: 14px; color: #444;">We've put together our eleventh newsletter — a closer look at the week through photos and classroom moments.</p>

  <div style="background: #eef6ee; border: 1px solid #a8c5a0; border-radius: 8px; padding: 20px 24px; margin: 28px 0; text-align: center;">
    <p style="margin: 0 0 6px 0; font-size: 15px; font-weight: bold; color: #2C5F2E;">📰 Our Eleventh Newsletter is Live!</p>
    <p style="margin: 0 0 18px 0; font-size: 13px; color: #555;">Photos, classroom moments, and a deeper look into our eleventh week.</p>
    <a href="https://sagefield.co/newsletter/1d25a4aa-b7b9-4692-b330-6356bce63356" style="background: #2C5F2E; color: #ffffff; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-family: Georgia, serif; font-size: 15px; display: inline-block;">Read the Newsletter →</a>
    <div style="margin-top: 14px;">
      <span style="display: inline-block; background: #f7f4f0; border: 1px solid #a8c5a0; border-radius: 999px; padding: 5px 14px; font-size: 12px; color: #555;">🔑 Password: <strong>weekeleven</strong></span>
    </div>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>🏫 <strong>School starts Monday, August 17</strong> — we can't wait to welcome everyone back for an exciting new year of learning, exploration, and adventure at Sage Field!</li>
      <li>💳 <strong>August tuition due tomorrow, August 10</strong> — one week before the first day of school. All billing details can be found in your Parent Portal: <a href="https://www.sagefield.co/parent/billing" style="color: #2C5F2E;">sagefield.co/parent/billing</a></li>
      <li>📅 <strong>Parent-Teacher Conferences</strong> — conference links are now live! Conferences are optional, but we encourage families to take advantage of this opportunity. You may choose in-person or virtual. To sign up, log into your Sage Field online portal at <a href="https://sagefield.co/parent/home" style="color: #2C5F2E;">sagefield.co/parent/home</a> or on the mobile app and select from the available time options.</li>
      <li>🏷️ <strong>Label your children's items</strong> — due to the influx of lost and found items, please be sure to label your children's belongings. We do our best to keep items together or display them on the pick-up table, but labeling supports your children's independence as they pack up for themselves.</li>
    </ul>
  </div>

  <h2 style="font-size: 17px; color: #2C5F2E; margin-top: 32px; margin-bottom: 14px;">🎒 What to Pack for the Summer!</h2>
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>🍱 Snack + lunch</li>
      <li>🩱 Swimsuit</li>
    ...
    <p style="margin: 16px 0 0 0; font-size: 13px; color: #555;">Please send <strong>spray sunscreen</strong> and <strong>spray bug spray only</strong>, with the exception of sunscreen facial stick. Extra shoes may be left at Sage Field — pick them up on your last day.</p>
  </div>
...
export async function buildSchoolYearWeekOneNewsletterEmail(opts: {
  g1FullName: string;
  childLegalName: string;
}): Promise<{ subject: string; content: string }> {
  const firstName = opts.g1FullName.split(" ")[0];
  const subject =
    "Week One Newsletter — Our First Week of School is a Wrap! 🌿";
  const content = `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8" /></head>
<body style="font-family: Georgia, serif; color: #2c2c2c; max-width: 600px; margin: 0 auto; padding: 32px 24px; line-height: 1.7;">
  ...
  <p style="margin-bottom: 20px;">Our first week of school is officially a wrap — and what a wonderful start it has been! The curiosity, excitement, and joy our students brought each day have made it incredibly special already.</p>

  <p style="margin-bottom: 20px; font-size: 14px; color: #444;">We've put together our first school year newsletter — a closer look at the week through photos and classroom moments.</p>

  <div style="background: #eef6ee; border: 1px solid #a8c5a0; border-radius: 8px; padding: 20px 24px; margin: 28px 0; text-align: center;">
    <p style="margin: 0 0 6px 0; font-size: 15px; font-weight: bold; color: #2C5F2E;">📰 Our First School Year Newsletter is Live!</p>
    <p style="margin: 0 0 18px 0; font-size: 13px; color: #555;">Photos, classroom moments, and a deeper look into our first week.</p>
    <a href="https://sagefield.co/newsletter/007754b1-1abb-4e77-83b1-0f7914e01e53" style="background: #2C5F2E; color: #ffffff; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-family: Georgia, serif; font-size: 15px; display: inline-block;">Read the Newsletter →</a>
    <div style="margin-top: 14px;">
      <span style="display: inline-block; background: #f7f4f0; border: 1px solid #a8c5a0; border-radius: 999px; padding: 5px 14px; font-size: 12px; color: #555;">🔑 Password: <strong>weekone</strong></span>
    </div>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>🌱 <strong>Joy's Class (Pre-K–K)</strong> — community building, routines, handwriting, and our <strong>"I Think, I Wonder, I Know"</strong> concept</li>
      <li>🐝 <strong>Sabrina's Class (3rd–4th)</strong> — routines &amp; community; writing/CUPS, <em>The Wild Robot</em>; math, art, homesteading, music, and sharing</li>
      <li>🌟 <strong>Zelinda's Class (1st–2nd)</strong> — Firefly routines; math &amp; reading stations; show &amp; tell; All About Me posters — photos to <a href="mailto:zelinda.sagefield@gmail.com" style="color: #2C5F2E;">zelinda.sagefield@gmail.com</a></li>
    </ul>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>🌿 <strong>Sage Field Community Garden Day</strong> — Thursday, August 27 | 5:30–7:00 PM. Join us for planting, painting, snacks, and community! RSVP: <a href="https://sagefield.co/community" style="color: #2C5F2E;">sagefield.co/community</a></li>
      <li>🚧 <strong>Field Friday: Construction Zone</strong> — sign up for Friday on your Parent Portal through Tuition and Billing</li>
    </ul>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>🌡️ <strong>Hot weather</strong> — temperatures may reach up to 104°F. Please send lightweight, breathable clothing. We'll take heat breaks and adjust outdoor activities as needed</li>
      <li>💳 <strong>September tuition</strong> — due next <strong>Tuesday, September 1st</strong>. Pay through your Parent Portal under Tuition/Billing</li>
      <li>📅 <strong>Parent-Teacher Conferences</strong> — schedule through the Parent Portal home page or the Sage Field mobile app</li>
  ...
  <p style="margin-bottom: 8px; font-size: 14px; color: #555;">We are so thankful for each of your families and for the beautiful community we are building together. Here's to an incredible school year ahead! 🌱</p>
...
export async function buildSchoolYearWeekThreeNewsletterEmail(opts: {
  g1FullName: string;
  childLegalName: string;
}): Promise<{ subject: string; content: string }> {
  const firstName = opts.g1FullName.split(" ")[0];
  const subject =
    "Week 3 Newsletter — Hands-On Science, Art & Exploration 🌿";
  const content = `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8" /></head>
<body style="font-family: Georgia, serif; color: #2c2c2c; max-width: 600px; margin: 0 auto; padding: 32px 24px; line-height: 1.7;">
  ...
  <p style="margin-bottom: 20px;">What a wonderful third week at Sage Field! Our students are continuing to settle into their routines, strengthen classroom connections, and grow more comfortable as learners within our community. This week brought plenty of opportunities for curiosity, creativity, exploration, and hands-on learning.</p>

  <p style="margin-bottom: 20px; font-size: 14px; color: #444;">We're beginning to see the foundations of our school year take shape — not only academically, but also through collaboration, independence, confidence, and a growing sense of community. We've put together our school year newsletter — a closer look at the week through photos and classroom moments.</p>

  <div style="background: #eef6ee; border: 1px solid #a8c5a0; border-radius: 8px; padding: 20px 24px; margin: 28px 0; text-align: center;">
    <p style="margin: 0 0 6px 0; font-size: 15px; font-weight: bold; color: #2C5F2E;">📰 Week 3 Newsletter is Live!</p>
    <p style="margin: 0 0 18px 0; font-size: 13px; color: #555;">Photos, classroom moments, and a deeper look into our week.</p>
    <a href="https://sagefield.co/newsletter/d227bcca-1942-4180-9eda-a3d9be538276" style="background: #2C5F2E; color: #ffffff; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-family: Georgia, serif; font-size: 15px; display: inline-block;">Read the Newsletter →</a>
    <div style="margin-top: 14px;">
      <span style="display: inline-block; background: #f7f4f0; border: 1px solid #a8c5a0; border-radius: 999px; padding: 5px 14px; font-size: 12px; color: #555;">🔑 Password: <strong>weekthree</strong></span>
    </div>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <div style="margin-bottom: 18px; padding-bottom: 18px; border-bottom: 1px solid #e0dbd5;">
      <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #2C5F2E;">Joy's Class (Pre-K–K)</p>
      <p style="margin: 0; font-size: 14px; color: #2c2c2c;">Homemade Play-Doh, soup, juice, and a DIY juicer; Yayoi Kusama-inspired patterns; early writing with dates and letter formation.</p>
    </div>
    <div style="margin-bottom: 18px; padding-bottom: 18px; border-bottom: 1px solid #e0dbd5;">
      <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #2C5F2E;">Zelinda's Class (1st–2nd)</p>
      <p style="margin: 0; font-size: 14px; color: #2c2c2c;">Comparing and ordering numbers; gummy worm scientific-method investigation; Wild West Field Friday wrap-up as August closes.</p>
    </div>
    <div style="margin-bottom: 0;">
      <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #2C5F2E;">Sabrina's Class (3rd–4th)</p>
      <p style="margin: 0; font-size: 14px; color: #2c2c2c;">Project H2O water-filtration designs and celery color experiment; place value and multi-digit math; <em>The Wild Robot</em>, spelling, perspective art, and soup cooking.</p>
    </div>
    <p style="margin: 16px 0 0 0; font-size: 13px; color: #555;">Read the full classroom stories, photos, and details in the newsletter above.</p>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>🧜🏽‍♀️ <strong>Field Friday: Dragons &amp; Mythical Creatures</strong> — sign up for Friday on your Parent Portal through Tuition and Billing</li>
    </ul>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>🎯 <strong>Activity Preferences</strong> — set in the Parent Portal before upcoming activities so your child can participate in planned experiences</li>
      <li>📅 <strong>Parent-Teacher Conferences</strong> — optional; schedule through the Parent Portal or the Sage Field mobile app (happening this week)</li>
      <li>☀️ <strong>Sunscreen &amp; bug spray</strong> — spray sunscreen, spray bug spray, and facial sunscreen sticks only. Please do not send cream sunscreen or cream bug spray for the body</li>
      <li>🏷️ <strong>Label belongings</strong> — please label all of your child's belongings with their name</li>
      <li>🚗 <strong>Drop-off &amp; pick-up</strong> — please pull through the gate during drop-off and pick-up. Do not park in the front unless the gates are closed</li>
    </ul>
  ...
  <p style="margin-bottom: 8px; font-size: 14px; color: #555;">We're so proud of the progress we're seeing and excited to keep building on these early weeks!</p>
...
export async function buildSchoolYearWeekFourNewsletterEmail(opts: {
  g1FullName: string;
  childLegalName: string;
}): Promise<{ subject: string; content: string }> {
  const firstName = opts.g1FullName.split(" ")[0];
  const subject =
    "Week 4 Newsletter — Chickens, Tornadoes & Dot Day 🌿";
  const content = `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8" /></head>
<body style="font-family: Georgia, serif; color: #2c2c2c; max-width: 600px; margin: 0 auto; padding: 32px 24px; line-height: 1.7;">
  ...
  <p style="margin-bottom: 20px;">I hope everyone had a wonderful weekend! Week 4 was full of curiosity, creativity, and hands-on learning — from exploring multiplication and building tornado-resistant structures to creating Dot Day artwork, cooking together, and developing personal writing.</p>

  <p style="margin-bottom: 20px; font-size: 14px; color: #444;">It has been wonderful watching our students grow in confidence as they ask questions, try new things, and discover new ways to express their ideas. We've put together our school year newsletter — a closer look at the week through photos and classroom moments.</p>

  <div style="background: #eef6ee; border: 1px solid #a8c5a0; border-radius: 8px; padding: 20px 24px; margin: 28px 0; text-align: center;">
    <p style="margin: 0 0 6px 0; font-size: 15px; font-weight: bold; color: #2C5F2E;">📰 Week 4 Newsletter is Live!</p>
    <p style="margin: 0 0 18px 0; font-size: 13px; color: #555;">Photos, classroom moments, and a deeper look into our week.</p>
    <a href="https://sagefield.co/newsletter/7c992696-e1e4-42d9-8f20-daad6a9d247b" style="background: #2C5F2E; color: #ffffff; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-family: Georgia, serif; font-size: 15px; display: inline-block;">Read the Newsletter →</a>
    <div style="margin-top: 14px;">
      <span style="display: inline-block; background: #f7f4f0; border: 1px solid #a8c5a0; border-radius: 999px; padding: 5px 14px; font-size: 12px; color: #555;">🔑 Password: <strong>weekfour</strong></span>
    </div>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <div style="margin-bottom: 18px; padding-bottom: 18px; border-bottom: 1px solid #e0dbd5;">
      <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #2C5F2E;">Joy's Class (Pre-K–K)</p>
      <p style="margin: 0; font-size: 14px; color: #2c2c2c;">Students investigated why the chickens haven't laid eggs yet — exploring the chicken life cycle, building a "Chicken Cam," and combining science, math, and writing into a collaborative documentation piece.</p>
    </div>
    <div style="margin-bottom: 18px; padding-bottom: 18px; border-bottom: 1px solid #e0dbd5;">
      <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #2C5F2E;">Zelinda's Class (1st–2nd)</p>
      <p style="margin: 0; font-size: 14px; color: #2c2c2c;">Addition foundations and globe geography (continents, oceans, hemispheres); Dot Day plate art prep; Field Friday recap with dragons, mermaid slime, and dragon eggs.</p>
    </div>
    <div style="margin-bottom: 0;">
      <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #2C5F2E;">Sabrina's Class (3rd–4th)</p>
      <p style="margin: 0; font-size: 14px; color: #2c2c2c;">Multiplication unit launch, tornado-resistant engineering builds, Dot Day ombré plate art, strawberry apple yogurt parfaits, and personal "Story of Me" writing.</p>
    </div>
    <p style="margin: 16px 0 0 0; font-size: 13px; color: #555;">Read the full classroom stories, photos, and details in the newsletter above.</p>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>🏜️ <strong>Field Friday: Desert Discovery</strong> — sign up for Friday on your Parent Portal through Tuition and Billing</li>
    </ul>
  </div>
  ...
  <p style="margin-bottom: 8px; font-size: 14px; color: #555;">We're so proud of the curiosity and joy our students bring each day — and excited for another week of learning together!</p>
...
export async function buildSchoolYearWeekFiveNewsletterEmail(opts: {
  g1FullName: string;
  childLegalName: string;
}): Promise<{ subject: string; content: string }> {
  const firstName = opts.g1FullName.split(" ")[0];
  const subject =
    "Week 5 Newsletter — Chicken Eggs, Ant Investigations & Desert Discovery 🌿";
  const content = `
<!DOCTYPE html>
<html>
<head><meta charset="utf-8" /></head>
<body style="font-family: Georgia, serif; color: #2c2c2c; max-width: 600px; margin: 0 auto; padding: 32px 24px; line-height: 1.7;">
  ...
  <p style="margin-bottom: 20px;">What a wonderful week of learning, curiosity, and creativity! From celebrating our first chicken eggs and beginning our ant investigation to strengthening skills across every subject, our students were busy exploring. We had a visit from Mr. Craig for music, celebrated Dot Day with our collaborative mural, explored color theory through art, and ventured into the desert for Field Friday: Desert Discovery!</p>
  ...
  <div style="background: #eef6ee; border: 1px solid #a8c5a0; border-radius: 8px; padding: 20px 24px; margin: 28px 0; text-align: center;">
    <p style="margin: 0 0 6px 0; font-size: 15px; font-weight: bold; color: #2C5F2E;">📰 Week 5 Newsletter is Live!</p>
    <p style="margin: 0 0 18px 0; font-size: 13px; color: #555;">Photos, classroom moments, and a deeper look into our week.</p>
    <a href="https://sagefield.co/newsletter/f18b3d3d-9eb0-49ed-aa61-ce59b982a7bd" style="background: #2C5F2E; color: #ffffff; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-family: Georgia, serif; font-size: 15px; display: inline-block;">Read the Newsletter →</a>
    <div style="margin-top: 14px;">
      <span style="display: inline-block; background: #f7f4f0; border: 1px solid #a8c5a0; border-radius: 999px; padding: 5px 14px; font-size: 12px; color: #555;">🔑 Password: <strong>weekfive</strong></span>
    </div>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <div style="margin-bottom: 18px; padding-bottom: 18px; border-bottom: 1px solid #e0dbd5;">
      <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #2C5F2E;">Joy's Class (Pre-K–K)</p>
      <p style="margin: 0; font-size: 14px; color: #2c2c2c;">Students investigated why the chickens weren't laying eggs — building a "chicken cam," making observations, and celebrating when they got their first eggs! That same curiosity is now leading into an ant investigation, with students preparing a proposal for a classroom ant farm and welcoming Ziggy, a kid-friendly Echo, to help with questions.</p>
    </div>
    <div style="margin-bottom: 18px; padding-bottom: 18px; border-bottom: 1px solid #e0dbd5;">
      <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #2C5F2E;">Zelinda's Class (1st–2nd)</p>
      <p style="margin: 0; font-size: 14px; color: #2c2c2c;">Strengthening addition skills, sight word and reading practice, and map skills through an interactive booklet. Color theory with a color wheel lion, Dot Day mural completion, and Field Friday: Desert Discovery with sunset cactus painting, desert bingo, and pasta snake crafts.</p>
    </div>
    <div style="margin-bottom: 0;">
      <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #2C5F2E;">Sabrina's Class (3rd–4th)</p>
      <p style="margin: 0; font-size: 14px; color: #2c2c2c;">Multiplication milestones (facts 0–10 and two-digit multiplication), volcano science with survival guides and eruption experiments, persuasive writing launch, nature art, and potato and rice chicken bone broth soup.</p>
    </div>
    <p style="margin: 16px 0 0 0; font-size: 13px; color: #555;">Read the full classroom stories, photos, and details in the newsletter above.</p>
  </div>
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; border-radius: 4px; margin-bottom: 24px;">
    <ul style="margin: 0; padding-left: 18px; line-height: 2.1; font-size: 14px; color: #2c2c2c;">
      <li>☀️ <strong>Summer-Ween — October 14</strong> — afternoon water slides, water play, and outdoor fun after lunch. Bring swimsuit, towel, change of clothes; optional safe/gentle water gun</li>
      <li>🥚 <strong>Sage Field Farm Fresh Eggs</strong> — $5/dozen at pickup (~2 dozen/week, first come first serve), Venmo or cash; proceeds support the chicken fund</li>
      <li>🎃 <strong>Halloween costumes</strong> — Thursday Oct 29 and Friday Oct 30 (Halloween is Saturday Oct 31)</li>
    </ul>
  </div>
  ...
  <p style="margin-bottom: 8px; font-size: 14px; color: #555;">We love watching our students' questions and curiosity guide their learning — and we can't wait to see where their next discoveries take us!</p>
...
export async function buildSchoolYearTuitionDueDateTodayReminderEmail(opts: {
  g1FullName?: string;
  childLegalName?: string;
  email: string;
}): Promise<{ subject: string; content: string }> {
  ...
  const subject = `August Tuition Due Tonight — 2026–2027`;
...
<body style="font-family: Georgia, serif; color: #2c2c2c; max-width: 600px; margin: 0 auto; padding: 32px 24px; line-height: 1.7;">
  ...
  <p style="margin-bottom: 16px;">
    If you haven't yet — a quick reminder that <strong>August tuition is due tonight at midnight (August 10)</strong>.
  </p>

  <p style="margin-bottom: 16px;">
    Please submit payment through your parent billing portal under the <strong>"School Year"</strong> tab before midnight tonight.
    The school year begins on <strong>August 17</strong>.
  </p>
...
export async function buildActivityPreferenceReminderEmail(opts: {
  g1FullName: string;
  childLegalName: string;
...
<body style="font-family: Georgia, serif; color: #2c2c2c; max-width: 600px; margin: 0 auto; padding: 32px 24px; line-height: 1.7;">
  ...
  <div style="background: #f7f4f0; border-left: 3px solid #a8c5a0; padding: 16px 20px; margin: 24px 0; border-radius: 4px;">
    ...
    <p style="margin: 0; font-size: 14px; color: #555;">${opts.activityDate}</p>
  </div>

  <p style="margin-bottom: 16px; font-size: 14px; color: #555;">Setting preferences helps us respect each child's comfort level, dietary needs, and allergies during food-related activities. It only takes a minute.</p>

  <div style="text-align: center; margin: 28px 0;">
    <a href="${preferencesUrl}" style="background: #2C5F2E; color: #fff; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-family: Georgia, serif; font-size: 15px; display: inline-block;">Set Activity Preferences →</a>
  </div>
