            ...
            <div className="flex-shrink-0 sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between z-10">
              <div>
                ...
                <p className="text-xs text-gray-400 font-body mt-0.5">
                  {studentName} · {localSigs[`${CONTRACT_6_ID}-1`] ? "1" : "0"}{" "}
                  of 1 sections signed
                </p>
              </div>
              <button
                onClick={onClose}
              ...
              <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    I, the undersigned parent or legal guardian, acknowledge
                    that participation in the educational, recreational, and
                    extracurricular activities offered by Sage Field Private
                    School &quot;School&quot; involves inherent risks. These
                    risks may include, but are not limited to, physical injury
                    from falls, collisions, equipment use, or other
                    participants; exposure to communicable illness; emotional or
                    psychological stress; allergic reactions; and other
                    unforeseen hazards that may arise during normal school
                    activities, field trips, outdoor education, and community
                    events.
                  </p>
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    I understand that no environment can be made entirely
                    risk-free and that Sage Field Private School, while
                    committed to maintaining a safe and supportive environment,
                    cannot guarantee complete freedom from injury or illness.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    With full knowledge of the risks described above, I
                    voluntarily enroll my child in Sage Field Private School and
                    authorize their participation in all school-sanctioned
                    activities. I freely and expressly assume all risks
                    associated with such participation, whether known or
                    unknown, foreseeable or unforeseeable, including the risk of
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    In consideration of my child&apos;s enrollment and
                    participation, I, on behalf of myself, my child, and our
                    heirs, successors, and legal representatives, hereby
                    release, waive, discharge, and hold harmless Sage Field
                    Academy, its officers, directors, employees, volunteers,
                    independent contractors, and agents (collectively,
                    &quot;Released Parties&quot;) from any and all claims,
                    demands, damages, liabilities, actions, or causes of action
                    — whether arising from negligence or otherwise — that may
                    result from my child&apos;s participation in school
                    activities.
                  </p>
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    I further agree to indemnify and hold harmless the Released
                    Parties from any claims brought by or on behalf of my child
                    arising out of or related to their participation in school
                    activities, including any claims arising from the negligence
                    of the Released Parties, to the fullest extent permitted by
                    applicable law.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    This Agreement applies to all activities conducted under the
                    auspices of Sage Field Private School, including but not
                    limited to: on-campus instruction and activities, field
                    trips and off-site excursions, outdoor and nature-based
                    education, school-sponsored community events, and any
                    transportation provided by or arranged by the School.
                  </p>
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    Nothing in this Agreement shall be construed to release any
                    party from liability arising from willful or grossly
                    negligent conduct, or from any liability that cannot be
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    ...
                    to make it enforceable, or, if modification is not possible,
                    shall be severed from this Agreement, while the remaining
                    provisions shall continue in full force and effect. This
                    Agreement constitutes the entire understanding between the
                    parties regarding the assumption of risk and release of
                    liability for{" "}
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    By signing below, I confirm that I have read and fully
                    understand this Assumption of Risk and Liability Release. I
                    acknowledge that I am signing this Agreement freely and
                    voluntarily, without any duress or undue influence, and that
                    I have had the opportunity to seek independent legal counsel
                    if desired. I represent that I have the legal authority to
                    execute this Agreement on behalf of my child.
                  </p>
