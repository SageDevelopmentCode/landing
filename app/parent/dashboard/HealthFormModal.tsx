...
function validateRequiredFields(draft: HealthDraft): string[] {
  ...
  if (!draft.inStateContactRelation.trim())
    errors.push("In-state contact relationship");
  if (!draft.inStateContactPhone.trim()) errors.push("In-state contact phone");
  if (!draft.outOfStateContactName.trim())
    errors.push("Out-of-state contact name");
  if (!draft.outOfStateContactRelation.trim())
    errors.push("Out-of-state contact relationship");
  if (!draft.outOfStateContactPhone.trim())
    errors.push("Out-of-state contact phone");
...
export default function HealthFormModal({
  ...
  const signedCount = Array.from(
    { length: CONTRACT_3_TOTAL_SECTIONS },
    (_, i) => i + 1,
  ).filter((i) => !!localSigs[`${CONTRACT_3_ID}-${i}`]).length;
              ...
              <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    In case the parent/guardian cannot be reached, Sage Field
                    may contact or release the child to the following
                    individuals. I authorize the above individuals to pick up my
                    child if I cannot be reached.
                  </p>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                      ...
                      <FormField
                        ...
                        onChange={(v) =>
                          set("inStateContactPhone", formatPhone(v))
                        }
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                      ...
                      <FormField
                        ...
                        onChange={(v) =>
                          set("outOfStateContactPhone", formatPhone(v))
                        }
                        placeholder="(555) 000-0000"
                        required
                      />
                ...
                <div className="flex flex-col gap-4">
                  <SectionHeader
                    number="4"
                    title="Physician and Medical Information"
                  />
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    <FormField
                      ...
                      onChange={(v) => set("physicianPhone", formatPhone(v))}
                      placeholder="(555) 000-0000"
                      required
                    />
                    <FormField
                  ...
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    If emergency treatment is needed and I/we cannot be reached,
                    I authorize Sage Field Private School staff to seek
                    necessary medical attention from the nearest licensed
                    physician, hospital, or emergency facility.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {(app.has_medical_conditions === "yes" ||
                  ...
                  <div className="flex flex-col gap-2">
                    <p className="text-xs font-semibold text-gray-600 font-body">
                      Is your child currently receiving care from a healthcare
                      provider for an ongoing condition?
                    </p>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {(app.has_emergency_medications === "yes" ||
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          set("emergencyMedicationRequired", false)
                        }
                        className={`cursor-pointer px-4 py-2 rounded-xl text-sm font-semibold font-body border transition-colors ${
                          !draft.emergencyMedicationRequired
                            ? "bg-gray-800 text-white border-gray-800"
                    ...
                    {draft.emergencyMedicationRequired && (
                      <FormTextarea
                        ...
                        onChange={(v) =>
                          set("emergencyMedicationDescription", v)
                        }
                  ...
                  {draft.emergencyMedicationRequired && (
                    <div className="bg-amber-50 border border-amber-100 rounded-xl px-4 py-3">
                      <p className="text-xs text-amber-700 font-body leading-relaxed">
                        If yes, parents must provide: a completed Emergency
                        Medication Authorization Form, medication in its
                        original clearly labeled container, and any specific
                        care instructions from the prescribing provider.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="flex flex-col gap-4">
                  <SectionHeader
                    number="7"
                    title="Immunization Record or Exemption"
                  />
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    Texas law requires all schoolchildren to provide proof of
                    current immunizations or a valid exemption affidavit.
                    Students may not begin attendance until one of the following
                    is on file with administration.
                  </p>
                  <div className="flex flex-col gap-2">
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p
                          className={`text-xs font-body mt-0.5 ${draft.immunizationStatus === "record" ? "text-gray-300" : "text-gray-400"}`}
                        >
                          I will upload a copy of my child&apos;s current
                          immunization record (signed or stamped by a physician
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p
                          className={`text-xs font-body mt-0.5 ${draft.immunizationStatus === "exemption" ? "text-gray-300" : "text-gray-400"}`}
                        >
                          I will submit a valid Texas DSHS exemption affidavit
                  ...
                  <p className="text-xs text-gray-400 font-body italic">
                    Uploading the actual document is a separate step in your
                ...
                <div className="flex flex-col gap-4">
                  ...
                  />
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    Sage Field Private School staff do not administer
                    prescription or over-the-counter medications. The only
                    exception is for life-saving emergency medications (e.g.,
                    EpiPen, inhaler) with prior written authorization. By
                    initialing below, you acknowledge and agree to this policy.
                  </p>
                  <SignatureGate
                ...
                <div className="flex flex-col gap-4">
                  ...
                  />
                  <p className="text-sm text-gray-600 font-body leading-relaxed">
                    Parents may provide sunscreen labeled with the child&apos;s
                    name for individual use only. No shared topical products or
                    other applications will be permitted to ensure allergy
                    safety. By initialing below, you acknowledge this policy.
                  </p>
                  <SignatureGate
                    healthInfoReady={healthInfoReady}
                    sectionId={2}
                  ...
                  <div className="flex flex-col gap-2 text-sm text-gray-600 font-body">
                    ...
                    <ul className="flex flex-col gap-1.5 mt-1">
                      <li className="flex gap-2">
                        ...
                        <span>
                          All information provided on this form is true and
                          accurate.
                        </span>
                      </li>
                      <li className="flex gap-2">
                        ...
                        <span>
                          I understand and accept Sage Field Private
                          School&apos;s health, medication, and outdoor
                          policies.
                        </span>
                      </li>
                      <li className="flex gap-2">
                        ...
                        <span>
                          I authorize Sage Field Private School staff holding
                          current First Aid/CPR certification to administer
                          reasonable first aid or to seek emergency medical care
                      ...
                      <li className="flex gap-2">
                        ...
                        <span>
                          I assume responsibility for all associated medical
                          expenses.
                        </span>
                      </li>
                      <li className="flex gap-2">
                        ...
                        <span>
                          I agree to notify Sage Field Private School promptly
                          of any changes to the information provided in this
                          form.
                        </span>
                      </li>
                    </ul>
              ...
              {allSigned ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-500 font-body">
                    ...
                    {CONTRACT_3_TOTAL_SECTIONS - signedCount !== 1
                      ? "s"
                      : ""}{" "}
                    remaining
                  </span>
