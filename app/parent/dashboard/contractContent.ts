...
export const CONTRACT_1_SECTIONS: ContractSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Tuition is due on the 1st of each month. A grace period of three (3) calendar days is provided. Accounts not paid by the 4th of the month will incur a $50 late fee per day until the balance is paid.",
