...
export default function EnrollmentCodeEntry({ autoOpen = false }: Props) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="text-sm text-amber-800 underline underline-offset-2 hover:text-amber-900 font-body transition-colors"
      >
