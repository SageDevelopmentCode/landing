...
export default function SettingsScreen() {
  ...
  function handleDeleteAccount() {
    Alert.alert(
      "Delete Account",
      "This will permanently delete your account. Your family's enrollment and health records will be retained by the school for compliance purposes.",
      [
  ...
  async function executeDelete() {
    ...
    try {
      ...
      notifyError('parent-delete-account', err);
      setDeleting(false);
      Alert.alert(
