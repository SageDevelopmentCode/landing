...
function PostCard({ post, currentUserId, onPress, onReact, onLongPressReaction }: PostCardProps) {
      ...
      {posts.length === 0 ? (
        <View style={styles.centered}>
          <View style={styles.emptyCard}>
            ...
            <Text style={styles.emptyBody}>Check back soon for updates from your teachers.</Text>
          </View>
        </View>
      ) : (
        <FlatList
